    ...
    <div class="login-wrap">
        <div class="inner-login-wrap signup-form">
            ...
            <form action="function/login.php" method="post">
                ...
                <div class="wrap-input form-group">
                    <label>
                        <span id="BodyPlaceHolder_lblFirstName">First Name</span>
                        <span class="star"> *</span>
                    </label>
                    <i class="fa fa-user"></i>
                    <input name="first_name" type="text" maxlength="50" id="BodyPlaceHolder_txtFirstName" class="form-control" placeholder="Name"/>

                </div>
                <div class="wrap-input form-group">
                    <label>
                        <span id="BodyPlaceHolder_lblLastName">Last Name</span>
                        <span class="star"> *</span></label>
                    <i class="fa fa-user"></i>

                    <input name="last_name" type="text" maxlength="50" id="BodyPlaceHolder_txtLastName" class="form-control" placeholder="Name"/>
                </div>
                <div class="wrap-input form-group">
                    <label>
                        <span id="BodyPlaceHolder_LabelPhoneNumber">Phone Number</span>
                        <span class="star"> *</span></label>
                    <i class="fa fa-phone"></i>

                    <input name="phone" type="text" maxlength="20" id="BodyPlaceHolder_txtPhoneNumber" class="sign-up-input" placeholder="+95 1 502 077"/>
                </div>
                <div class="wrap-input form-group">
                    <label>
                        <span id="BodyPlaceHolder_lblJobTitle">What are you looking for</span><span
                                class="star"> *</span></label>
                    <i class="fa fa-user"></i>
                    <input name="looking_for" type="text" maxlength="50" id="BodyPlaceHolder_txtJobTitle" class="sign-up-input" placeholder="Job Title"/>

                </div>
                <div class="wrap-input form-group">
                    <label>
                        <span id="BodyPlaceHolder_lblJobFunction">Your Primary Job Function</span>
                        <span class="star"> *</span></label>
                    <select name="ctl00$BodyPlaceHolder$ddlJobFunction" id="BodyPlaceHolder_ddlJobFunction" class="sign-up-select">
                ...
                <div class="wrap-input form-group">
                    <label>
                        <span id="BodyPlaceHolder_lblExperienceLevel">Your Experience Level</span>
                        <span class="star"> *</span>
                    </label>
                    <select name="experience" id="BodyPlaceHolder_ddlExperienceLevel" class="sign-up-select">
                ...
                <div class="wrap-input form-group">
                    <label>
                        <span id="BodyPlaceHolder_lblLocation">Your Current Location</span>
                        <span class="star"> *</span></label>
                    <select name="locaton" id="BodyPlaceHolder_ddlLocation" class="sign-up-select">
